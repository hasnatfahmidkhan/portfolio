...
const Contact = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="flex-grow flex flex-col items-center justify-start px-6 md:px-12 lg:px-24 py-12 relative overflow-hidden min-h-[calc(100vh-100px)]"
    >
      {/* Toast Notifications */}
      <Toaster
        position="top-center"
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    className={`w-full bg-gray-50 dark:bg-[#161b22] border ${
                      errors.name
                        ? "border-red-500"
                        : "border-gray-300 dark:border-gray-700"
                    } rounded-lg px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors placeholder-gray-400`}
                    id="name"
                ...
                <textarea
                  className={`w-full bg-gray-50 dark:bg-[#161b22] border ${
                    errors.message
                      ? "border-red-500"
                      : "border-gray-300 dark:border-gray-700"
                  } rounded-lg px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors placeholder-gray-400 resize-none`}
                  id="message"
